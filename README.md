...
An open-source sports analytics web application built for the **AQX Sports Analytics Data Bowl 2.0**. This tool simulates the remainder of the 2026 World Cup tournament from the Round of 16 onward using dynamic Elo rating differentials.
